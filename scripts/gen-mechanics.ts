...
const MECHANICS: MechanicDefinition[] = [
  {
    ...
    description: "The unit's Basic Attacks miss and deal no damage. Ability damage is unaffected.",
  ...
  },
  {
    ...
    slug: "slowed",
    category: "Crowd Control",
    description: "The unit moves more slowly. Most slows stack multiplicatively and are cleansed by Unstoppable.",
  ...
  },
  {
    ...
    slug: "rooted",
    category: "Crowd Control",
    description: "The unit cannot move. It can still attack and use Abilities that do not move it.",
  ...
  },
  {
    ...
    slug: "stunned",
    category: "Crowd Control",
    description: "The unit cannot move, attack, or use Abilities.",
  ...
  },
  {
    ...
    slug: "silenced",
    category: "Crowd Control",
    description: "The unit cannot use Abilities, but can still move and attack.",
  ...
  },
  {
    ...
    slug: "feared",
    category: "Crowd Control",
    description: "The unit runs uncontrollably and cannot attack or use Abilities.",
  ...
  },
  {
    ...
    slug: "polymorphed",
    category: "Crowd Control",
    description: "The unit cannot attack or use Abilities, but can still move.",
  ...
  },
  {
    ...
    slug: "taunted",
    category: "Crowd Control",
    description: "The unit is forced to move toward and Basic Attack the caster.",
  ...
  },
  {
    ...
    slug: "time-stop",
    category: "Crowd Control",
    description: "The unit is frozen in time. It cannot act, be hit, or be targeted, and its cooldowns and durations stop for the duration.",
  ...
  },
  {
    ...
    slug: "sleeping",
    category: "Crowd Control",
    description: "The unit cannot act until it takes damage, which wakes it up early.",
  ...
  },
  {
    ...
    description: "The unit takes no damage from any source.",
  ...
  },
  {
    ...
    slug: "shield",
    category: "Defensive Buffs",
    description: "The unit gains a temporary pool of extra health that absorbs incoming damage before its own health is lost.",
  ...
  },
  {
    ...
    slug: "evasion",
    category: "Defensive Buffs",
    description: "The unit dodges incoming Basic Attacks. Ability damage still applies.",
  ...
  },
  {
    ...
    slug: "stagger",
    category: "Defensive Buffs",
    description: "Part of the damage the unit takes is delayed instead of dealt at once, and can be paid back over time.",
  ...
  },
  {
    ...
    slug: "spell-absorb",
    category: "Defensive Buffs",
    description: "The unit takes no damage from Abilities. Basic Attacks still apply.",
  ...
  },
  {
    ...
    slug: "unstoppable",
    category: "Defensive Buffs",
    description: "The unit cannot be affected by crowd control, and existing crowd control is removed.",
  ...
  },
  {
    ...
    slug: "invulnerable",
    category: "Defensive Buffs",
    description: "The unit takes no damage and cannot be affected by crowd control.",
  ...
  },
  {
    ...
    slug: "stasis",
    category: "Defensive Buffs",
    description: "The unit is removed from combat. It cannot act, deal or take damage, or be targeted.",
  ...
  },
  {
    ...
    slug: "armor",
    category: "Defensive Buffs",
    description: "Reduces the damage the unit takes from all sources by a percentage. Negative values increase damage taken.",
  ...
  },
  {
    ...
    slug: "physical-armor",
    category: "Defensive Buffs",
    description: "Reduces the damage the unit takes from Basic Attacks by a percentage.",
  ...
  },
  {
    ...
    slug: "magical-armor",
    category: "Defensive Buffs",
    description: "Reduces the damage the unit takes from Abilities by a percentage.",
  ...
  },
  {
    ...
    category: "Defensive Buffs",
    description: "The unit receives more healing from all sources.",
  ...
  },
  {
    ...
    description: "The unit attacks more often.",
  ...
  },
  {
    ...
    category: "Offensive Buffs",
    description: "The unit deals more Basic Attack and Ability damage.",
  ...
  },
  {
    ...
    category: "Offensive Buffs",
    description: "The unit deals more Basic Attack damage.",
  ...
  },
  {
    ...
    category: "Offensive Buffs",
    description: "The unit's Abilities deal more damage and heal for more.",
  ...
  },
  {
    ...
    category: "Offensive Buffs",
    description: "The unit heals for a percentage of the Basic Attack damage it deals.",
  ...
  },
  {
    ...
    category: "Offensive Buffs",
    description: "The unit heals for a percentage of the Ability damage it deals.",
  ...
  },
  {
    ...
    description: "The unit takes more damage from all sources.",
  ...
  },
  {
    ...
    category: "Offensive Debuffs",
    description: "The unit takes more damage from Basic Attacks.",
  ...
  },
  {
    ...
    category: "Offensive Debuffs",
    description: "The unit takes more damage from Abilities.",
  ...
  },
  {
    ...
    category: "Offensive Debuffs",
    description: "The unit attacks less often.",
  ...
  },
  {
    ...
    category: "Offensive Debuffs",
    description: "The unit deals less Basic Attack and Ability damage.",
  ...
  },
  {
    ...
    category: "Offensive Debuffs",
    description: "The unit's Abilities deal less damage and heal for less.",
  ...
  },
  {
    ...
    category: "Offensive Debuffs",
    description: "The unit receives less healing from all sources.",
  ...
  },
  {
    ...
    description: "The unit is visible to enemies through fog of war, shrubs, and stealth.",
  ...
  },
  {
    ...
    slug: "cloaked",
    category: "Stealth and Vision",
    description: "The unit is hidden from enemy vision until it is revealed.",
