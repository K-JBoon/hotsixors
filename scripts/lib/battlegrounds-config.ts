...
export const BATTLEGROUNDS: BattlegroundConfig[] = [
  ...
  },
  {
    ...
    summary: [
      ...
      "Every wave starts with 6 Zerglings and an Ultralisk. Charging adds Banelings, Hydralisks, Guardians, and up to 2 more Ultralisks.",
      "The first Zerg wave picks a random lane. Each wave after that goes to the other lane.",
      "The Archangel boss spawns at 5:00 and respawns 250 seconds after it's taken. It pushes the enemy lane whose Fort side has the most Structure Health left.",
    ...
    timers: [
      ...
      { label: "Drop Pod Cooldown", galaxyConst: "libSCHO_gv_zergDropPodCooldownTime_C", note: "per team" },
    ...
    mechanics: [
      ...
      {
        title: "Zerg Waves",
        body: "When the beacons open, each cell gets 6 Zerglings and 1 Ultralisk for free. While a cell charges, it adds a Baneling for every 10%, a Hydralisk for every 24%, a Guardian for every 30%, and an Ultralisk for every 45% (2 at most). A full cell sends 6 Zerglings, 10 Banelings, 4 Hydralisks, 3 Guardians, and 3 Ultralisks. A cell at 40% sends 6 Zerglings, 4 Banelings, 1 Hydralisk, 1 Guardian, and 1 Ultralisk.\n\nZerg go for Minions and Structures first, but they attack Heroes in their way. While a Guardian or Ultralisk is attacking, its team drops a Drop Pod with 3 Zerglings and a Hydralisk near the target, once every 13 seconds. There is no limit per wave.",
        codeBlockSpec: {
          galaxyFile: SCHO,
          matchPattern: "void libSCHO_gf_MMHOModifySpawnProgressVariables",
          contextLines: 12,
        },
      },
      {
