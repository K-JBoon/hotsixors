...
const ICON_PATHS = {
  ...
  plus: '<path d="M7.1 2h1.8v5.1H14v1.8H8.9V14H7.1V8.9H2V7.1h5.1z"/>',
  close:
    '<path d="M3.5 2.2 8 6.7l4.5-4.5 1.3 1.3L9.3 8l4.5 4.5-1.3 1.3L8 9.3l-4.5 4.5-1.3-1.3L6.7 8 2.2 3.5z"/>',
  chevronLeft: '<path d="M10.6 2.4 11.9 3.7 7.6 8l4.3 4.3-1.3 1.3L5 8z"/>',
  chevronRight: '<path d="M5.4 2.4 11 8l-5.6 5.6-1.3-1.3L8.4 8 4.1 3.7z"/>',
